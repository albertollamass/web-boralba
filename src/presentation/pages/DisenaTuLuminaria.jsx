...
export default function DisenaTuLuminaria({ quoteSender }) {
  if (!quoteSender) throw new Error('DisenaTuLuminaria necesita quoteSender (puerto QuoteSender)')
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      const json = await quoteSender.submitQuoteRequest(data)
